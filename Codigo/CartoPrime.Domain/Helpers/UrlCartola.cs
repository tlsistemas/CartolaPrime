...
namespace CartoPrime.Domain.Helpers
{
    public class UrlCartola
    {
        ...
        public static string _timeSlug = Protocol.HTTPS + RootCartola.CAF + "time/id/";
        ...
        public static String _dicasexclusivas = "https://i.ibb.co/NYZtCF6/dicasexclusivas.png";
        public static String _top5 = "https://i.ibb.co/kKcMzdB/top5.png";
        public static String _estatisticas = "https://i.ibb.co/4JznDdG/estatisticas.png";
        public static String _arbitragem = "https://i.ibb.co/mqYqPHc/arbitragem.png";
